...
text is committed (`results/rarefaction/RAREFACTION_RESULT.txt`); the intermediate `merged_rare13M.tsv` and
per-sample profiles are gitignored and regenerated by re-running the two scripts. Refs: MetaPhlAn 4
