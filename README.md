...
`figures/rarefaction_richness.png` = paired Observed-richness native→rarefied per library; `figures/rarefaction_richness_bar.png` = grouped bar chart of median richness ± IQR by compartment).
